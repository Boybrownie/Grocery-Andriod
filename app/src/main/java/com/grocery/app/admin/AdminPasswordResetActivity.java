...
public class AdminPasswordResetActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_reset.setOnClickListener(v -> {
            ...
            if (email.equals("")) {
                Toast.makeText(AdminPasswordResetActivity.this, "Email is empty", Toast.LENGTH_SHORT).show();
            } else {
                progressDialog.show();
                ...
                emailQuery.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        if (dataSnapshot.exists()) {
                            ...
                            Toast.makeText(AdminPasswordResetActivity.this, "Email is not registered, " + "try signing up..!", Toast.LENGTH_SHORT).show();
                        }
                    }
                    ...
                    public void onCancelled(@NonNull DatabaseError databaseError) {
                        ...
                        Toast.makeText(AdminPasswordResetActivity.this, "Error validating email, " + "try again later..!", Toast.LENGTH_SHORT).show();
                    }
                });
            }
        });
        ...
        new Thread(() -> {
            ...
            runOnUiThread(() -> {
                ...
                if (result) {
                    ...
                    Toast.makeText(AdminPasswordResetActivity.this, "Failed to send email", Toast.LENGTH_SHORT).show();
                }
            });
        }).start();
    }
